package sri.spring.boot.properties.parentchild;



        import sri.spring.boot.properties.parentchild.config.ChildConfig2;
        import sri.spring.boot.properties.parentchild.config.ParentConfig2;
